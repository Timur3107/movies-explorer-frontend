...
function SavedMovies({ handleSearch, handleSaveMovie,handleDeleteMovie }) {
    const movies = [
        {
            "id": 31,
            "nameRU": "Тинейдж",
    ...
    return (
        <section className='savedmovies'>
            ...
            <MoviesCardList handleSaveMovie={handleSaveMovie} handleDeleteMovie={handleDeleteMovie} movies={movies} isSavedMovies={true}></MoviesCardList>
        </section>
    );
}
