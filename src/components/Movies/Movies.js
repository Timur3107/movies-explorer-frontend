...
function Movies({handleSearch, handleSaveMovie,handleDeleteMovie}) {
    // временное решение
    const movies = [
        {
            "id": 5,
    ...
    return (
        <section className='movies'>
            ...
            <MoviesCardList handleSaveMovie={handleSaveMovie} movies={movies} isSavedMovies={false} handleDeleteMovie={handleDeleteMovie}></MoviesCardList>
